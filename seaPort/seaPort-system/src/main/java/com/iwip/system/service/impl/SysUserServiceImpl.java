        ...
        for (SysUser user : userList)
        {
            try
            {
                ...
                if (StringUtils.isNull(u))
                {
                    ...
                    // 默认角色
                    if (StringUtils.isNotBlank(user.getRoleIdStr())) {
                        String[] roleIdArr = user.getRoleIdStr().split(";");
                        user.setRoleIds(Arrays.stream(roleIdArr).map(Long::valueOf).toArray(Long[]::new));
                    }
