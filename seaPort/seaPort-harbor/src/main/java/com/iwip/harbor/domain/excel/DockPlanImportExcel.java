...
public class DockPlanImportExcel {
...
//    @Excel(name = "状态",readConverterExp = "0=计划,1=在途,2=等泊,3=靠泊,4=在装卸,5=待离泊,6=待离港,7=完成,8=移泊")
//    private String status;

    @Excel(name = "卡数")
    private String cardCount;

    public Date getPlanDockingTime() {
        return planDockingTime;
    }

    public void setPlanDockingTime(Date planDockingTime) {
        this.planDockingTime = planDockingTime;
    }

    @Excel(name = "计划靠泊时间",dateFormat = "yyyy-MM-dd HH:mm:ss")
    private Date planDockingTime;
