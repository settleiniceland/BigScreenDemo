...
import com.iwip.common.utils.file.MinioUtil;
...
import com.iwip.common.config.SeaPortConfig;
...
//        {
//            LoginUser loginUser = getLoginUser();
//            String avatar = FileUploadUtils.upload(SeaPortConfig.getAvatarPath(), file, MimeTypeUtils.IMAGE_EXTENSION);
...
//        return error("上传图片异常，请联系管理员");
        ...
        try {
            ...
            sysUser.setUserId(SecurityUtils.getUserId()); // 用户ID
            sysUser.setAvatar(filePath);                  // 头像
            ...
            return AjaxResult.error("上传失败，未知错误");
        }
