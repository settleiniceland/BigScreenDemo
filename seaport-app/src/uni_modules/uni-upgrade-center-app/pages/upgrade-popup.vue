  ...
  <view class="mask flex-center">
    <view class="content botton-radius">
      ...
      <view class="content-body">
        <view class="title">
          <text>{{ subTitle }}</text>
          <text class="content-body-version">{{ updateInfo.version }}</text>
        </view>
        <view class="body">
...
export default {
  ...
  computed: {
    isWGT() {
      return this.updateInfo.hotUpdate || false
    },
    isiOS() {
      return false
    },
  ...
  methods: {
    ...
    downloadPackage() {
      ...
      console.log(`下载地址：${baseUrl}/${this.updateInfo.uri}`)
      // 下载包
      downloadTask = uni.downloadFile({
        url: `${baseUrl}/${this.updateInfo.uri}`,
        success: (res) => {
      ...
      downloadTask.onProgressUpdate((res) => {
        ...
        this.downloadedSize = (res.totalBytesWritten / 1024 ** 2).toFixed(2)
